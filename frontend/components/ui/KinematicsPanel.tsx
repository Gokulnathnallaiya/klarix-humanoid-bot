          ...
          {Object.entries(groupedJoints).map(([groupName, groupJoints]) => (
            <div key={groupName}>
              <div className="flex items-center gap-1 mb-2">
                ...
                <span className="text-xs font-medium text-slate-400 uppercase">{groupName}</span>
              </div>
              
              <div className="grid grid-cols-1 gap-1.5">
                {groupJoints.map(joint => (
                  <div key={joint.name} className="flex items-center gap-2">
                    <span className="text-xs text-slate-500 w-28 truncate" title={joint.name}>
        ...
        <div className="mt-4 pt-4 border-t border-white/10">
          <div className="flex justify-center">
            <svg viewBox="0 0 100 140" className="w-24 h-32">
              ...
              {/* Head */}
              <circle cx="50" cy="15" r="12" fill="none" stroke="currentColor" strokeWidth="2" className="text-slate-600" />
              <circle cx="50" cy="15" r="3" fill="currentColor" className="text-cyan-500" />
              
              {/* Body */}
              <rect x="35" y="30" width="30" height="40" rx="3" fill="none" stroke="currentColor" strokeWidth="2" className="text-slate-600" />
              
              {/* Left Arm */}
              <line x1="35" y1="35" x2="15" y2="55" stroke="currentColor" strokeWidth="2" className="text-slate-600" />
              <circle cx="35" cy="35" r="3" fill="currentColor" className="text-purple-500" />
              <circle cx="25" cy="45" r="2" fill="currentColor" className="text-purple-400" />
              
              {/* Right Arm */}
              <line x1="65" y1="35" x2="85" y2="55" stroke="currentColor" strokeWidth="2" className="text-slate-600" />
              <circle cx="65" cy="35" r="3" fill="currentColor" className="text-purple-500" />
              <circle cx="75" cy="45" r="2" fill="currentColor" className="text-purple-400" />
              
              {/* Left Leg */}
              <line x1="42" y1="70" x2="38" y2="100" stroke="currentColor" strokeWidth="2" className="text-slate-600" />
              <line x1="38" y1="100" x2="35" y2="130" stroke="currentColor" strokeWidth="2" className="text-slate-600" />
              <circle cx="42" cy="70" r="3" fill="currentColor" className="text-emerald-500" />
              <circle cx="38" cy="100" r="2" fill="currentColor" className="text-emerald-400" />
              
              {/* Right Leg */}
              <line x1="58" y1="70" x2="62" y2="100" stroke="currentColor" strokeWidth="2" className="text-slate-600" />
              <line x1="62" y1="100" x2="65" y2="130" stroke="currentColor" strokeWidth="2" className="text-slate-600" />
              <circle cx="58" cy="70" r="3" fill="currentColor" className="text-emerald-500" />
              <circle cx="62" cy="100" r="2" fill="currentColor" className="text-emerald-400" />
            </svg>
          </div>
          <p className="text-xs text-center text-slate-500 mt-2">Joint positions</p>
        </div>
      )}
